  ...
  return (
    <div className={classes.root}>
      ...
      В случае, если профиль закрытый, то рекомендуется использовать легендирование для получения доступа к старнице, то есть под вымышленным предлогом запроситься в друзья.
        ...
        <Typography gutterBottom>
        3. Исследование списка друзей также несёт обязательно. Именно они могут сказать, где большинство близкого круга живёт, какой возраст. Список друзей может иметь категории, которые определил владелец страницы "родственники", "друзья по школе" и т.д.
        </Typography>
